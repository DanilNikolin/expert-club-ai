        ...
        <Tooltip
          content={
            name === 'constructiveness'
              ...
              : name === 'temperature'
              ? 'Низкие значения: логичность и предсказуемость. Высокие: больше креативности и безумных идей. Значение > 1.0: бот может начать галлюцинировать. Значение ~2.0: станет шизофреником.'
              : ''
          }
        />
      </label>
